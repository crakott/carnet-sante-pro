...
import ChirurgiesSection from '../../components/ChirurgiesSection';
import { useAnimals } from '../../context/AnimalsContext';

export default function ChirurgiesScreen() {
  ...
  return (
    <Screen>
      ...
      {animal ? <ChirurgiesSection animal={animal} addAnimalItem={addAnimalItem} deleteAnimalItem={deleteAnimalItem} updateAnimalItem={updateAnimalItem} /> : <EmptyState>Sélectionnez un animal</EmptyState>}
    </Screen>
  );
}
