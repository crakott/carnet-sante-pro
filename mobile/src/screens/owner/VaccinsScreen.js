...
export default function VaccinsScreen() {
  ...
  return (
    <Screen>
      ...
      {animal ? <VaccinsSection animal={animal} addAnimalItem={addAnimalItem} deleteAnimalItem={deleteAnimalItem} updateAnimalItem={updateAnimalItem} /> : <EmptyState>Sélectionnez un animal</EmptyState>}
    </Screen>
  );
}
